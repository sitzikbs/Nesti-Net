...
addpath('/home/itzik/Datasets/nyu v2/toolbox/') % path to nyu v2 toolbox
data_path = '/home/itzik/Datasets/nyu v2/nyu_v2_txt/';
results_path = '/home/itzik/PycharmProjects/NestiNet/log/my_experts_kinect/_results/';
...
for i = 1:size(shapes_to_export,1)
    ...
    if export_normal_vis
        ...
        for i = 1:length(x(:))
            normal_img( y(i), x(i), 1:3) =  reshape(mapped_normal_colors(i, :), [1, 1, 3]);
        end
