...
def get_point_clouds(get_original_pcpnet=False):
    ...
    if get_original_pcpnet:
        ...
        source_url = 'https://gitlab.cs.technion.ac.il/sitzikbs/nesti-net-resources/blob/master/data/'
        ...
        source_url = 'https://gitlab.cs.technion.ac.il/sitzikbs/nesti-net-resources/blob/master/'
        target_dir = os.path.join(BASE_DIR, 'data/')
...
def get_trained_model(fetch_all=False):
    ...
    if fetch_all:
        source_url = 'https://gitlab.cs.technion.ac.il/sitzikbs/nesti-net-resources/blob/master/log/'
...
if __name__ == '__main__':
    ...
    # repo_path='https://gitlab.cs.technion.ac.il/sitzikbs/nesti-net-resources.git'
    # get_point_clouds_and_models_from_repo(repo_url=repo_path)