...
parser.add_argument('--normal_results_path', default='log/experts/pcpnet_results/', help='Log dir [default: log]')
...
parser.add_argument('--dataset_list', type=str, default=['testset_temp'], nargs='+',
...
normal_results_path = os.path.join(BASE_DIR, FLAGS.normal_results_path)
